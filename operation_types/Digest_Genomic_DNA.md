...
Step 3 in preparation of yeast DNA library samples for NGS. 
Full flow is:
...
- **Zymoprepped sample** []  
  - <a href='#' onclick='easy_select("Sample Types", "DNA Library")'>DNA Library</a> / <a href='#' onclick='easy_select("Containers", "Plasmid Library")'>Plasmid Library</a>
